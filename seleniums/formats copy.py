...
date_start.send_keys("202201")
for i in range(6):
    date_end.send_keys(Keys.BACKSPACE)
date_end.send_keys("202212")
...
for i in range(0,len(region_select)-1):
    ...
    time.sleep(5)
    month_visitor = browser.find_element(By.CSS_SELECTOR,"#\\31 264 > div.top > div.menu-more-wrap > a")
    month_visitor.click()
    month_downroad = browser.find_element(By.CSS_SELECTOR,"#\\31 264 > div.top > div.menu-more-wrap > ul > li:nth-child(2) > p:nth-child(2) > a")
    month_downroad.click()
    time.sleep(2)
    ...
    concept_consume = browser.find_element(By.CSS_SELECTOR,"#\\31 268 > div.top > div.menu-more-wrap > a")
    concept_consume.click()
    concept_consume_downroad = browser.find_element(By.CSS_SELECTOR,'#\\31 268 > div.top > div.menu-more-wrap > ul > li:nth-child(2) > p:nth-child(3) > a')
    ...
    time.sleep(30)
    pass
#\31 242 > div.top > div.menu-more-wrap > a
