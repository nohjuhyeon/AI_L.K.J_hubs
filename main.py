...
async def init_db():
    ...
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=1, minute=0)    
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=5, minute=0)    
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=9, minute=0)    
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=13, minute=0)    
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=17, minute=0)    
    scheduler.add_job(kto9suk9suk_scraping, trigger='cron', hour=21, minute=0)    
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=3, minute=0)
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=7, minute=0)
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=11, minute=0)
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=15, minute=0)
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=19, minute=0)
    scheduler.add_job(yeomi_scraping, trigger='cron', hour=23, minute=0)
